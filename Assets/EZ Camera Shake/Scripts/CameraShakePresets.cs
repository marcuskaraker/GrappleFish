...
namespace EZCameraShake
{
    ...
    public enum CameraShakeMode { None, Bump, Explosion, Earthquake, BadTrip, Vibration }
    ...
    public static class CameraShakePresets
    {
        ...
        public static CameraShakeInstance Explosion
        {
            get
            {
                ...
                c.PositionInfluence = Vector3.one * 0.15f;
                c.RotationInfluence = new Vector3(0, 0, 0);
                return c;
            }
        }
        ...
        /// <summary>
        /// [Sustained] A sligtly rough, low magnitude shake.
        /// </summary>
        public static CameraShakeInstance Drill
        {
            get
            {
                CameraShakeInstance c = new CameraShakeInstance(0.5f, 5f, 1f, 1f);
                c.PositionInfluence = Vector3.one * 0.1f;
